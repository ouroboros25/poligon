...
class FacebookConnector implements SocialNetworkConnector
{
    ...
    public function logIn(): void
    {
        echo "FacebookConnector Send HTTP API request to log in user $this->login with " .
    ...
    public function logOut(): void
    {
        echo "FacebookConnector Send HTTP API request to log out user $this->login\n";
        echo '<br>';
    }

    public function createPost($content): void
    {
        echo "FacebookConnector Send HTTP API requests to create a post in Facebook timeline.\n";
        echo '<br>';
    }
}
...
class LinkedInConnector implements SocialNetworkConnector
{
    ...
    public function logIn(): void
    {
        echo "LinkedInConnector Send HTTP API request to log in user $this->email with " .
            "password $this->password\n";
        echo '<br>';
    }
    ...
    public function logOut(): void
    {
        echo "LinkedInConnector Send HTTP API request to log out user $this->email\n";
        echo '<br>';
    }

    public function createPost($content): void
    {
        echo "LinkedInConnector Send HTTP API requests to create a post in LinkedIn timeline.\n";
        echo '<br>';
    }
}
...
echo "<img src='img/factory.png' width='900px'>";
echo '<br>';
